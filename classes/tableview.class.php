                ...
                if ($row['is_started'] == 1) {
                    if ($row['timer'] > 0) {
                        if ($to_sec_end <= $local_time) {
                            ?>
                            <td class="table-timer-col table-<?php echo $row['number'] ?>-time endtime" id="<?php echo $row['number'] ?>" started=<?php echo $row['is_started'] ?> starttime=<?php echo $row['timer'] ?> endtime=<?php echo $row['end_time'] ?> counter=<?php echo $row['counter']; ?> show=<?php echo $row['show'] ?>>
                            <?php
                        }
                        elseif($to_sec_warning <= $local_time){
                            ?>
                            <td class="table-timer-col table-<?php echo $row['number'] ?>-time warningtime" id="<?php echo $row['number'] ?>" started=<?php echo $row['is_started'] ?> starttime=<?php echo $row['timer'] ?> endtime=<?php echo $row['end_time'] ?> counter=<?php echo $row['counter']; ?> show=<?php echo $row['show'] ?>>
                            <?php
                        }
                        else{
                            ?>
                            <td class="table-timer-col table-<?php echo $row['number'] ?>-time runningtime" id="<?php echo $row['number'] ?>" started=<?php echo $row['is_started'] ?> starttime=<?php echo $row['timer'] ?> endtime=<?php echo $row['end_time'] ?> counter=<?php echo $row['counter']; ?> show=<?php echo $row['show'] ?>>
                            <?php
                        }
                    }
                }
                    ...
                    if ($row['timer'] == 0) {
                        ?>
                        <td class="table-timer-col table-<?php echo $row['number'] ?>-time" id="<?php echo $row['number'] ?>" started=<?php echo $row['is_started'] ?> starttime=<?php echo $row['timer'] ?> endtime=<?php echo $row['end_time'] ?> counter=<?php echo $row['counter']; ?> show=<?php echo $row['show'] ?>>
                        <?php
                    }
                    elseif ($row['timer'] > 0){
                        ?>
                        <td class="table-timer-col table-<?php echo $row['number'] ?>-time runningtimeend" id="<?php echo $row['number'] ?>" started=<?php echo $row['is_started'] ?> starttime=<?php echo $row['timer'] ?> endtime=<?php echo $row['end_time'] ?> counter=<?php echo $row['counter']; ?> show=<?php echo $row['show'] ?>>
                        <?php
                    }
                }
                ?>
