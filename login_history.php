...
?>
        ...
        <div class="dropdown date-transaction ">
            ...
            <ul class="dropdown-menu">
                <li class="ps-2">
                    ...
                    <input type="date" name="" id="" class="search-login-history" placeholder="start date">
                </li>
                <li class="ps-2 mt-2">
                    <span>End time:</span>
                    <input type="date" name="" id="" class="search-login-history-2" placeholder="start date">
                </li>
            </ul>
        </div>
    ...
    <div class="main-content tables-container">
        <div class="tables">
            <table class="tables-table loginhistory-table-info table hide">
            </table>
            <table class="tables-table loginhistory-table-info-date table">
            </table>
        </div>
    </div>
    ...
    <script src="js/login_history.js?v=<?php echo time(); ?>"></script>
