...
?>
        ...
        <div class="dropdown date-transaction ">
            ...
            <ul class="dropdown-menu">
                <li class="ps-2">
                    ...
                    <input type="date" name="" id="" class="search-compliance" placeholder="start date">
                </li>
                <li class="ps-2 mt-2">
                    <span>End time:</span>
                    <input type="date" name="" id="" class="search-compliance-2" placeholder="start date">
                </li>
            </ul>
        </div>
    ...
    <div class="main-content tables-container">
        <div class="tables">
            <table class="tables-table compliance-tbl table">
            </table>
            <table class="tables-table compliance-tbl-date table hide">
            </table>
        </div>
    </div>
